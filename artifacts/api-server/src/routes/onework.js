...
import { db, oneworkProfileTable, workCompaniesTable, workDocumentCategoriesTable, workDocumentFoldersTable, workDocumentsTable, workPfEntriesTable, workPfWithdrawalsTable, } from "@workspace/db";
import { DeleteWorkCompanyParams, DeleteWorkDocumentCategoryParams, DeleteWorkDocumentParams, DeleteWorkPfEntryParams, DeleteWorkPfWithdrawalParams, OneworkProfileInput, OneworkSummary, UpdateWorkCompanyParams, UpdateWorkDocumentCategoryParams, UpdateWorkDocumentParams, UpdateWorkPfEntryParams, UpdateWorkPfWithdrawalParams, WorkCompany, WorkCompanyInput, WorkCompanyUpdate, WorkDocument, WorkDocumentCategory, WorkDocumentCategoryInput, WorkDocumentCategoryUpdate, WorkDocumentFolder, WorkDocumentFolderInput, WorkDocumentFolderUpdate, WorkDocumentInput, WorkDocumentUpdate, WorkPfEntry, WorkPfEntryInput, WorkPfEntryUpdate, WorkPfWithdrawal, WorkPfWithdrawalInput, WorkPfWithdrawalUpdate, } from "@workspace/api-zod";
...
router.post("/onework/epfo/sync", async (_req, res) => {
    res.status(501).json({
