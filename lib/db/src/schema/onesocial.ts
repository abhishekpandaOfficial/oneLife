...
export type SocialContentItem = typeof socialContentItemsTable.$inferSelect;
export type SocialPlatformVersion = typeof socialPlatformVersionsTable.$inferSelect;
export type SocialPublishQueueItem = typeof socialPublishQueueTable.$inferSelect;
export type SocialConnector = typeof socialConnectorsTable.$inferSelect;
export type SocialHashtag = typeof socialHashtagsTable.$inferSelect;
export type SocialAnalytics = typeof socialAnalyticsTable.$inferSelect;
export type SocialAiSuggestion = typeof socialAiSuggestionsTable.$inferSelect;
export type SocialActivity = typeof socialActivityTable.$inferSelect;
export type SocialPerson = typeof socialPeopleTable.$inferSelect;
export type SocialCircle = typeof socialCirclesTable.$inferSelect;
export type SocialFollowup = typeof socialFollowupsTable.$inferSelect;
export type SocialAutomationRule = typeof socialAutomationRulesTable.$inferSelect;

export type InsertSocialCampaign = z.infer<typeof insertSocialCampaignSchema>;
export type InsertSocialContentItem = z.infer<typeof insertSocialContentItemSchema>;
export type InsertSocialPlatformVersion = z.infer<typeof insertSocialPlatformVersionSchema>;
export type InsertSocialPublishQueue = z.infer<typeof insertSocialPublishQueueSchema>;
export type InsertSocialConnector = z.infer<typeof insertSocialConnectorSchema>;
export type InsertSocialHashtag = z.infer<typeof insertSocialHashtagSchema>;
export type InsertSocialAiSuggestion = z.infer<typeof insertSocialAiSuggestionSchema>;
export type InsertSocialPerson = z.infer<typeof insertSocialPersonSchema>;
export type InsertSocialCircle = z.infer<typeof insertSocialCircleSchema>;
export type InsertSocialFollowup = z.infer<typeof insertSocialFollowupSchema>;
export type InsertSocialAutomationRule = z.infer<typeof insertSocialAutomationRuleSchema>;
